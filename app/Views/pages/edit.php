...
<div class="container">
    <div class="row">
        <div class="col">
            ...
            <h1 class="text-xl my-4">Edit Buku</h1>
            <form action="/edit/<?= $book['id']; ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="row mb-3">
                    <label for="judul" class="col-sm-2 col-form-label">Judul Buku</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control <?= ($validation->hasError('judul')) ? 'is-invalid' : ''; ?>" id="judul" name="judul" autofocus value="<?= $book['judul']; ?>">
                ...
                <div class="row mb-3">
                    <label for="penerbit" class="col-sm-2 col-form-label">Stok</label>
                    <div class="col-sm-10">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-2">
                        <img src="/img/<?= $book['sampul']; ?>" alt="Cover" class="img-thumbnail img-preview">
                    </div>
                    <div class="col-sm-8">
                        <div class="input-group mb-3">
                            <input type="file" class="form-control <?= ($validation->hasError('sampul')) ? 'is-invalid' : ''; ?>" id="sampul" name="sampul" onchange="previewImg()">
                            <input type="hidden" name="current_sampul" value="<?= $book['sampul']; ?>">
                            <div class="invalid-feedback">
